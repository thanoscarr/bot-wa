...
/////////////////
const BotName = 'THANOS BOT☄'; 
const instagram = 'https://instagram.com/tthanos.car'; 
const telegram = 'https://t.me/tthanoscar'; 
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@tthanos.car`)
})
